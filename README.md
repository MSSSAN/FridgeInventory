...
※깃허브 비디오 첨부 가능 용량을 맞추기 위해 로딩 시간 1분을 잘라냈습니다.
...
iOS 앱을 기반으로 AWS Lambda, S3, API Gateway, DynamoDB, Gemini를 활용해 구성했습니다.
...
이 기능의 목적은 사용자가 유통기한이 얼마 남지 않은 음식을 쉽게 파악함으로써 음식물의 낭비를 줄이는데 도움을 주기 위함입니다.
